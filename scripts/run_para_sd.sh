...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --num_processes 2 benchmark/eval_humaneval_qwen3.py --eval_mode para_sd --gamma 2 -n 1  -e H_DOU_qwen314b --draft_model qwen3-0.6b --target_model qwen3-14b --max_tokens 1024 --temp 0
